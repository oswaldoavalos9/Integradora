...
const simulateSensorData = () => {
  ...
  return {
    encendido: voltage > 50 ? 'Encendido' : 'Apagado',
    ocupado: isOccupied ? 'Ocupado' : 'Vacío',
...
const Inicio = ({ navigation }) => {
  ...
  const initialUnits = [
    { id: '1', unit: 'C1', planta: 'Planta Baja' },
    { id: '2', unit: 'C2', planta: 'Planta Baja' },
    { id: '3', unit: 'C3', planta: 'Planta Baja' },
    { id: '4', unit: 'C4', planta: 'Planta Baja' },
    { id: '5', unit: 'C5', planta: 'Planta Baja' },
  ];
  ...
  const renderItem = ({ item }) => {
    ...
    const hasAlert = item.encendido === 'Encendido' && item.ocupado === 'Vacío';
    ...
    return (
      ...
      >
        ...
        <View style={styles.statusCell}>
          <Text style={[
            styles.statusText,
            item.encendido === 'Encendido' ? styles.onText : styles.offText
          ]}>
            {item.encendido}
          </Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Planta Baja</Text>
